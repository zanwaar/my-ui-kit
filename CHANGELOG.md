...
All notable changes to `piceui` will be documented in this file.
...
### Added
- Initial npm package metadata for `piceui`
- Exported CSS distribution files for package consumers
- Exported vanilla JS helpers for dropdown and theme toggle
